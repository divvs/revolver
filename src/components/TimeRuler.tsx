...
export const TimeRuler = ({ timeScale, width, onTimeScaleChange, showMarkerLines = true }: TimeRulerProps) => {
  ...
  const getHourMarkerLabelStyle = (hour: number) => {
    ...
    return hoveredHour === hour ? TEXT_COLORS.HOUR_HOVERED : TEXT_COLORS.HOUR_BOLD;
  };
  ...
  return (
    ...
    >
        ...
        <div className="relative h-full flex">
          {markers.map((marker) => (
            <div
              ...
              onMouseEnter={() => !marker.isHour && setHoveredMinute(marker.minute + marker.hour * 60)}
      ...
      <div className="h-1 bg-gray-100 dark:bg-gray-800" /> {/* Scrollbar track */}
    </div>
  );
};